...
/* scopeId */
var __vue_scopeId__ = "data-v-75c4d0f0"
...
Component.options.__file = "resources\\assets\\js\\components\\page\\AdsIndex.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-75c4d0f0", Component.options)
  } else {
    hotAPI.reload("data-v-75c4d0f0", Component.options)
  }
...
var update = __webpack_require__(209)("b28bb200", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../../../../node_modules/_vue-loader@13.6.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-75c4d0f0\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/_vue-loader@13.6.1@vue-loader/lib/selector.js?type=styles&index=0&bustCache!./AdsIndex.vue", function() {
...
// module
exports.push([module.i, "\n.handle-box[data-v-75c4d0f0] {\n    margin-bottom: 20px;\n}\n.handle-select[data-v-75c4d0f0] {\n    width: 120px;\n}\n.handle-input[data-v-75c4d0f0] {\n    width: 300px;\n    display: inline-block;\n}\n.el-table .cell .el-button[data-v-75c4d0f0] {\n    margin: 5px 0;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getData: function getData() {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_0__fetch__["c" /* fetchAdList */])(this.listQuery).then(function (res) {
                if (res && res.data.status == __WEBPACK_IMPORTED_MODULE_1__utils_config__["c" /* ERR_OK */]) {
        ...
        // 添加产品
        handleAdsAdd: function handleAdsAdd() {
        ...
        handleOnline: function handleOnline(index, row) {
            ...
            this.$confirm('此操作将上线广告 ' + row.name + ', 是否继续?', '温馨提示', { type: 'warning' }).then(function () {
                Object(__WEBPACK_IMPORTED_MODULE_0__fetch__["e" /* fetchAdOnline */])(id).then(function (res) {
                    if (res && res.data.status == __WEBPACK_IMPORTED_MODULE_1__utils_config__["c" /* ERR_OK */]) {
                        _this4.tableData[index].status = 1;
                        _this4.$message.success('上线成功');
                    } else {
                        _this4.$message.error('上线失败');
                    }
                }).catch(function (error) {
        ...
        handleOffline: function handleOffline(index, row) {
            ...
            this.$confirm('此操作将下线广告 ' + row.name + ', 是否继续?', '温馨提示', { type: 'warning' }).then(function () {
                Object(__WEBPACK_IMPORTED_MODULE_0__fetch__["d" /* fetchAdOffline */])(id).then(function (res) {
                    if (res && res.data.status == __WEBPACK_IMPORTED_MODULE_1__utils_config__["c" /* ERR_OK */]) {
                        _this5.tableData[index].status = 2;
                        _this5.$message.success('下线成功');
                    } else {
                        _this5.$message.error('下线失败');
                    }
                }).catch(function (error) {
        ...
        handleDelete: function handleDelete(index, row) {
            ...
            this.$confirm('此操作将删除广告 ' + row.name + ', 是否继续?', '温馨提示', { type: 'warning' }).then(function () {
                Object(__WEBPACK_IMPORTED_MODULE_0__fetch__["a" /* fetchAdDel */])(id).then(function (res) {
                    if (res && res.data.status == __WEBPACK_IMPORTED_MODULE_1__utils_config__["c" /* ERR_OK */]) {
                        var _index = _this6.tableData.indexOf(row);
                        _this6.tableData.splice(_index, 1);
                        --_this6.total;
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c(
            "el-table-column",
            { attrs: { label: "广告信息", align: "center" } },
            [
              _c("el-table-column", {
                attrs: { prop: "title", label: "广告标题", align: "center" }
              }),
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { label: "广告类型", align: "center" },
                scopedSlots: _vm._u([
                  {
                    key: "default",
                    fn: function(scope) {
                ...
                scopedSlots: _vm._u([
                  {
                    ...
                    fn: function(scope) {
                      return [
                        _c("img", {
                          attrs: { src: scope.row.pic, width: "200" }
                        })
                      ]
                    }
                  }
              ...
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { prop: "showCnt", label: "曝光展示数", align: "center" }
              })
            ],
            1
          ),
          ...
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("el-table-column", {
                attrs: { prop: "clickCnt", label: "点击数", align: "center" }
              })
            ],
            1
          ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-75c4d0f0", module.exports)
  }
}
